...
import com.dio.sawcunha.beercontrol.exception.error.PersonNotFoundTaxIdentifierException;
...
public interface PersonService extends ServiceSpec<PersonRequestDTO, BeerControlResponse<?>>{
    ...
    BeerControlResponse<PersonResponseDTO> findByTaxIdentifier(String cpf) throws PersonNotFoundTaxIdentifierException;
