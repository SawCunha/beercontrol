...
public class AddressRequestDTO {
    ...
    public AddressRequestDTO(Long id, String zipCode, String city, String addressName, String state, String street, String country, Integer number, String block, String complement, String reference) {
        this.id = id;
